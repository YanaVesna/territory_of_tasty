        ...
        <div className="contacts__boxform">
          <div className="contacts__form">
            <div className="contacts__form__links">
              <div className="contacts__form__links__svglinks">
                <svg
                  width="18"
                  height="12"
                  viewBox="0 0 18 12"
              ...
              <div className="contacts__form__links__svglinks">
                <img src="/foto/svgs2.png" alt="" />
                <p>@mymeal</p>
              </div>
              <div className="contacts__form__links__svglinks">
                <img src="/foto/svgs3.png" alt="" />
                <p>+7 (938)833 24 15</p>
              </div>
            </div>
            <div className="contacts__form__input">
              <div className="contacts__form__input__box">
                <input className="contacts__form__input__name"></input>
                <input className="contacts__form__input__name"></input>
              </div>
              <div className="contacts__form__input__button">
                <input className="contacts__form__input__message"></input>
                <div className="contacts__form__input__button__div">
                  <ButtonOrder />
                </div>
              </div>
            </div>
